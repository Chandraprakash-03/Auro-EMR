    ...
    <section class="p-t-b-150"> 
      ...
      <div class="container"> 
        ...
        <div class="heading-block">
          <h4>GET IN TOUCH</h4>
          <hr>
          <span><h2 style="font-weight:bold;font-style:30px;"></h2>THANKYOU FOR SHARING YOUR REVIEW WITH US</span> </div>
          <P style="font-weight:bold;font-style:50px;">Admin will reply to your Message soon</p>
        <div class="contact">
                ...
                <div class="col-md-6">
                  <ul class="row">
                    ...
                    <li class="col-sm-12 no-margin">
                      <button type="submit" value="submit" class="btn" id="btn_submit" onClick="proceed();ahref=adminaccount.php">SEND MESSAGE</button>
                    </li>
                  </ul>
                </div>
              </div>
