...
<body class="theme-cyan">
    ...
    <nav class="navbar clearHeader">
        <div class="col-12">
            <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand"
                    href="#"><p style="font-style:bold;font-size:30px;">Aravind Eye Hospital - EMR</p></a></div>
            <ul class="nav navbar-nav navbar-right">
                <!-- Notifications -->
                <li>
                    <a data-placement="bottom" title="Full Screen" href="logout.php"><i
                            class="zmdi zmdi-sign-in"> Logout </i></a>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <!--Admin Menu -->
            <div class="menu">
                <ul class="list" style="overflow: hidden; width: auto; height: 100vh !important;">
                    <li class="header">MAIN NAVIGATION</li>
                    <li class="active open"><a href="adminaccount.php"><i
                                class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>

                    <li> <a href="cms.php"><i class="zmdi zmdi-copy"></i><span>CMS</span> </a></li>
            ...
            <div class="menu">
                <ul class="list" style="overflow: hidden; width: auto; height: 100vh !important;">
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>Profile</span> </a>
                        <ul class="ml-menu">
                            <li><a href="nurseprofile.php">Nurse Profile</a></li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <li><a href="viewdoctorvianurse.php">View Doctor</a></li>
                    ...
                    <li> <a href="javascript:void(0);" class="menu-toggle toggled waves-effect waves-block"><i
                        ...
                        <ul class="ml-menu" style="display: block;">
                            ...
                            <li><a href="viewtreatment.php" class=" waves-effect waves-block">View Treatment types</a></li>
                            <!-- <li><a href="medicine.php" class=" waves-effect waves-block">Add Medicine</a></li> -->
                            <li><a href="viewmedicinenurse.php" class=" waves-effect waves-block">View Medicine</a></li>
                        </ul>
                    </li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li> <a href="viewdoctorconsultancycharge.php"><i class="zmdi zmdi-copy"></i><span>IncomeReport</span> </a></li>
